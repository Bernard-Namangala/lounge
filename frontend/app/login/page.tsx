  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-dark-900 via-dark-800 to-dark-900 text-light-50 overflow-hidden flex items-center justify-center px-4 py-16">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[40%] left-[60%] w-[60%] h-[60%] rounded-full bg-primary-DEFAULT/5 blur-[100px]"></div>
        <div className="absolute -bottom-[20%] left-[10%] w-[50%] h-[50%] rounded-full bg-accent-DEFAULT/5 blur-[100px]"></div>
      </div>

      <div className="relative w-full max-w-md">
        {/* Glow effect behind card */}
        <div className="absolute inset-0 -z-10 blur-[80px] opacity-30">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] rounded-full bg-primary-DEFAULT/20"></div>
        </div>
        ...
        <div className="relative z-10 bg-gradient-to-br from-dark-800/90 to-dark-700/90 backdrop-blur-md p-10 rounded-2xl border border-dark-600 shadow-xl shadow-dark-900/50">
          ...
          <div className="text-center space-y-3 mb-8">
            ...
            <p className="text-sm text-light-400">
              ...
              <Link
                href="/signup"
                className="text-primary-light hover:text-primary-DEFAULT transition-colors font-medium"
              >
                Sign up
              </Link>
            </p>
          ...
          <form className="space-y-6">
            <div className="space-y-4">
              <div className="group">
                <label
                  htmlFor="email"
                  className="block text-sm font-medium text-light-200 mb-2 transition-colors group-focus-within:text-primary-light"
                >
                  Email address
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="w-full py-3 pl-10 pr-4 bg-dark-700/70 border border-dark-600 rounded-lg text-light-50 placeholder:text-light-500 focus:outline-none focus:ring-2 focus:ring-primary-DEFAULT/50 focus:border-primary-DEFAULT transition-all duration-300"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 rounded border-dark-600 bg-dark-700 text-primary-DEFAULT focus:ring-primary-DEFAULT focus:ring-offset-dark-800 transition-colors"
                />
                <label
                  htmlFor="remember-me"
              ...
              <Link
                ...
                className="text-sm text-primary-light hover:text-primary-DEFAULT transition-colors"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 bg-primary-DEFAULT hover:bg-primary-dark text-white rounded-lg transition-all duration-300 shadow-lg shadow-primary-DEFAULT/20 hover:shadow-xl hover:shadow-primary-DEFAULT/30 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-primary-light focus:ring-offset-2 focus:ring-offset-dark-800"
            >
              Sign in
            </button>
          </form>
